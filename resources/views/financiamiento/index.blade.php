                    ...
                    <table id="miTabla" class="table text-nowrap mb-0 align-middle table-striped table-bordered">
                        <thead class="text-dark fs-4">
                            <tr>
                                ...
                                <th class="border-bottom-0"><b>Tasa Interes</b></th>
                        ...
                        <tbody>
                            @foreach ($financiamientos as $financiamiento)
                                <tr>
                                    <td class="border-bottom-0">{{ $financiamiento->id_cliente }}</td>
                                    <td class="border-bottom-0">{{ $financiamiento->id_propiedad}}</td>
                                    <td class="border-bottom-0">{{ $financiamiento->tasaInteres }}</td>
                                    <td class="border-bottom-0">{{ $financiamiento->plazoAnos }}</td>
                                    <td class="border-bottom-0">{{ $financiamiento->pagoMensual }}</td>
                                    ...
                                    <td class="d-flex gap-1 justify-content-center">
                                        ...
                                        <form action="{{ route('financiamiento.destroy', $financiamiento->id_financiamiento) }}" method="POST" id="block-form-{{ $financiamiento->id_financiamiento }}">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-danger" onclick="confirmBlock({{ $financiamiento->id_financiamiento }})">
